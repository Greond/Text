...
namespace чтото_большое
{
    public partial class Form1 : Form
    {
        ...
        private void Sort1_Click(object sender, EventArgs e)
        {
            ...
            if (comboBox1.SelectedIndex == 1)
            {
               ...
               string[] mas = new string [listBox1.Items.Count];
                ...
                {
                    mas[i] = Convert.ToString(listBox1.Items[i]);
                }
                Array.Reverse(mas); 
                
                for(int i = 0; i < mas.Length; i++)
                {
                    listBox1.Items[i] = mas[i];
                }
            }
                if(comboBox1.SelectedIndex == 3)
            {
                ...
                for (int i = 0; i < mas.Length; i++)
                {
                    ...
                    {
                        if (mas[i].Length < mas[j].Length && i<j)
                        {
                            string temp = mas[i];
                            mas[i] = mas[j];
                            mas[j] = temp;
        ...
        private void Sort2_Click(object sender, EventArgs e)
        {
            ...
            {
                listBox2.Sorted = true;
                string[] mas = new string[listBox2.Items.Count];
                for (int i = 0; i < listBox2.Items.Count; i++)
                {
                    mas[i] = Convert.ToString(listBox2.Items[i]);
                }
                Array.Reverse(mas);

                for (int i = 0; i < mas.Length; i++)
                {
                    listBox2.Items[i] = mas[i];
                }
            }
